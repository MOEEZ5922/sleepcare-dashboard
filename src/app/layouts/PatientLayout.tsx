          ...
          <div className="flex justify-between items-start mb-3">
            ...
            <div className="flex flex-col items-end gap-2">
              <div className="flex items-center gap-1.5">
                ...
                <Link to={id ? `/patient/${id}` : '/login'} className="px-2 py-1 bg-white/10 text-white text-[10px] font-bold rounded hover:bg-white/20 transition-all uppercase tracking-tighter border border-white/30">PAT</Link>
                <button
