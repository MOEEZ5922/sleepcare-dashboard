        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-4">
             <div className="flex gap-2">
                ...
                <Link to={id ? `/patient/${id}` : '/login'} className="px-2 py-1 bg-[#6A994E]/10 text-[#6A994E] text-[10px] font-bold rounded hover:bg-[#6A994E]/20 transition-all uppercase tracking-tighter">PAT</Link>
             </div>
             <ConnectivityStatus />
          </div>
        </div>
