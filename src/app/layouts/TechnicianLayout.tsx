      ...
      <div className="w-64 bg-white border-r border-[#E8EEF2] flex flex-col">
        <div className="p-6 border-b border-[#E8EEF2]">
          ...
          <div className="mt-4 flex gap-2">
             ...
             <Link to="/login" className="px-2 py-1 bg-[#6A994E]/10 text-[#6A994E] text-[10px] font-bold rounded hover:bg-[#6A994E]/20 transition-all uppercase tracking-tighter">PAT</Link>
          </div>
        </div>
