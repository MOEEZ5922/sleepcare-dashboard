    ...
    <div className="min-h-screen bg-gradient-to-br from-navy via-navy/90 to-teal flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-card rounded-3xl shadow-2xl p-8 border border-white/10 relative z-10 animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="text-center mt-6 mb-8">
          ...
          <h2 className="text-xl font-black text-teal uppercase tracking-wider">Physician Portal</h2>
          <p className="text-xs text-slate-muted mt-1 font-semibold">Sign in to your clinical dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="text-[10px] text-slate-muted uppercase font-black tracking-widest block mb-2">Clinical Portal Password</label>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-teal hover:bg-teal/90 text-white rounded-xl font-bold text-sm shadow-lg shadow-teal/25 transition-all flex items-center justify-center gap-2 active:scale-98"
          >
            {loading ? (
              <>
